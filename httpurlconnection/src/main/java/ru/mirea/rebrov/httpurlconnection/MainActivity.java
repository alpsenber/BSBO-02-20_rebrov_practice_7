package ru.mirea.rebrov.httpurlconnection;
...
import java.net.URL;
import ru.mirea.rebrov.httpurlconnection.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity
{
    ...
    private class DownloadPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result)
        {
            ...
            binding.textView.setText(String.format("температура:  %s", temp));
            binding.textView2.setText(String.format("ветер:  %s", wind));
